...
<html>
<head>
	<title>Tailor SignUp</title>
	<link href="https://fonts.googleapis.com/css?family=Raleway:400,700" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">
	<link rel="stylesheet" type="text/css" href="tailorSignup.css">
</head>
<body>
...
<!-- navbar -->
	...
	<div class="container">
		...
		<hr>
		<h3>Wanna open an account of your tailor Shop? You are in the right place.</h3>
		<h3>Your Shop will be in our website in next couple of mintues.</h3>
	...
	<?php
		...
		{
			 $Shopname  = mysqli_real_escape_string($db->link , $_POST['ShopName']);
		 	 $Firstname = mysqli_real_escape_string($db->link , $_POST['OwnerFirstName']);
			 $Lastname = mysqli_real_escape_string($db->link , $_POST['OwnerLastName']);
			...
			$targetShop = "IMG/".basename($_FILES['ShopPic']['name']);
			$targetOwner = "IMG/".basename($_FILES['OwnerPic']['name']);
			$targetPrice = "IMG/".basename($_FILES['PriceDetails']['name']);
			//get all the data from the form
			$imageShop = $_FILES['ShopPic']['name'];
			$imageOwner = $_FILES['OwnerPic']['name'];
			$PriceDetails = $_FILES['PriceDetails']['name'];
			/*$query = "INSERT INTO tailor(ShopPic,OwnerPic) VALUES ('$imageShop','$imageOwner')";
			$create = $db-> upload($query); // stores the submitted data in the table tailor*/

			//move uploaded image into the folder IMG

			if(move_uploaded_file($_FILES['OwnerPic']['tmp_name'], $targetOwner))
			{
			...
			if(move_uploaded_file($_FILES['ShopPic']['tmp_name'], $targetShop))
			{
				$msg = "Image uploaded successfully!!!";
			}
			else
			...
			if(move_uploaded_file($_FILES['PriceDetails']['tmp_name'], $targetPrice))
			{
				$msg = "Image uploaded successfully!!!";
			}
			else
			{
			 ...
			 else
			 {
			 	...
			 	{
		 			$query = "INSERT INTO tailor(Shopname,Location,Firstname,Lastname,Email,Catagory,Password,Contact,Day,Month,Year,Gender,ShopPic,OwnerPic,PriceDetails) Values('$Shopname','$Location','$Firstname','$Lastname','$Email','$Catagory','$Password','$Contact','$Day','$Month','$Year','$Gender','$imageShop','$imageOwner','$PriceDetails')";
		...
		<div class="row">
			...
			<div class="col-sm-4 form">
				...
				<p>
					...
					<input id="ShopName" name="ShopName" type="text" placeholder="ShopName" required>
				</p>
				<p>
					<label for="OwnerFirstName">Owner's First Name:</label>
					<input id="OwnerFirstName" name="OwnerFirstName" type="text" placeholder="OwnerFirstName" required>
				</p>
				<p>
					<label for="OwnerLastName">Owner's Last Name:</label>
					<input id="OwnerLastName" name="OwnerLastName" type="text" placeholder="OwnerLastName" required>
				</p>
				<p>
					Category:
				...
				<p>
					<label for="ShopPic">Add Pictures of Shop:</label>
					<input id="ShopPic" name="ShopPic" type="file" placeholder="ShopPic" required>
					<!-- <button class="btn btn-success btn-sm">Add</button> -->
				</p>
				<p>
					<label for="OwnerPic">Add Picture of Owner:</label>
					<input id="OwnerPic" name="OwnerPic" type="file" placeholder="OwnerPic" required>
					<!-- <button class="btn btn-success btn-sm">Add</button> -->
				</p>
				<p>
					<label for="PriceDetails">Add Picture of Price details:</label>
					<input id="PriceDetails" name="PriceDetails" type="file" placeholder="PriceDetails" required>
					<!-- <button class="btn btn-success btn-sm">Add</button> -->
				</p>
